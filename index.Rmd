...
From 2005 to the present, there are `r totalCheckouts` on loan at the Seattle Public Library related to A Song of Ice and Fire. Of all those `r totalCheckouts` checked out, `r AudioPercentage`% is Audio book and `r Ebook Percentage`% is E book. however, of all checkouts in 2018 (the most recent full year), `r Audio2018Percentage`% of checkouts were Audio book, and only `r Ebook2018Percent`% were E book. the 2018 data may show a trend preference for borrowing Audio book or E book from the library in recent years.
